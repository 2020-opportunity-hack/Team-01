...
export class UserDatabase extends Component {
    ...
    componentDidMount() {
        ...
        const data = [{
            ...
            "tokenSpent": "500",
            "tokenDeposit": "988",
            "address": "abcdefadioasdiaj asdjaiodja adsiojdioajsdioajsjd asjjdiojasiodjas"
        }, {
            "id": "11",
            ...
            <div>
                    ...
                    <table className="bp3-html-table bp3-html-table-bordered  bp3-interactive"
                        ...
                        {userData.map((data, index) =>
                            <tr id={data.id + index}>
                                ...
                                <td>{data.address}</td>
                                <td><Tooltip content="View Details" position={Position.RIGHT}>
                                    <Icon icon="eye-open" iconSize={20} onClick={this.openViewMoreComponent.bind(this,data.id)}/></Tooltip>
                                </td>
                ...
                <Overlay isOpen={this.state.isOpenOverLay} onClose={this.toggleOverlay}>
                     <Card style={{width:"80%",marginLeft:"10%",marginTop:"10%"}}>
                         <ViewMoreDetails id={this.state.idRequested}/></Card>
                </Overlay>
            </div>
